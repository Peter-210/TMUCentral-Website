...
// To handle editing an ad from the my ads page
const EditAd = ({ onFormSubmit }) => {
  ...
  async function submitAd(imageBase64) {
    ...
    // To send the base 64 image string to the server
    ...
    // use the PATCH to edit the ad in the database
